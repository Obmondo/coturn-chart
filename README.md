...
* [Usage](#usage)
  ...
  * [Basics](#basics)
    ...
    * [Adding a user declaratively](#adding-a-user-declaritively)
    * [Databases](#databases)
...
We provide an optional [PXC DB](https://github.com/percona/percona-helm-charts/tree/main/charts/pxc-db) sub chart for deploying a MySQL cluster (Requires the Percona PXC Operator be pre-installed)
...
You're free to use any other values you find in the [Percona mysql helm values](https://github.com/percona/percona-helm-charts/tree/main/charts/pxc-db) under the `mysql` parameter in your values.yaml for coturn.
